...
extension NSDocument: DependencyHosting {
    /// Storage for the associated-object key. The address of this static
    ...
    /// The dependency container scoped to this document's window
    /// controllers and views. Defaults to an empty container until set.
    @MainActor
